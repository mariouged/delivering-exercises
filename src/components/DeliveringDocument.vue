...
function downloadDocument(download_url) {
  window.open(encodeURI(download_url))
}
</script>
...
<template>
  ...
  <div class="py-4 flex flex-row">
    <div class="basis-full text-sm">
      <p class="font-bold">VERSIÓN {{ delivering.version }}</p>
      <p><a href="#" @click="downloadDocument(delivering.download_url)" class="text-blue-500 font-bold" target="_blank">{{ delivering.name }}</a></p>
    ...
    <div class="basis-12 pt-6">
      <a href="#" @click="downloadDocument(delivering.download_url)" class="text-blue-500">
